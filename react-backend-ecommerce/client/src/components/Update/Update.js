...
const postUrl = "http://localhost:5000/api/products/1";
...
function Update() {
    return (
      ...
      {!admin ? (
        ...
        <form action={postUrl} method="patch" autoComplete="off">
          <div className="loginBody">
            <div className="form-group">
              <div  className="input-group mb-3">
                <input type="text" id="title" className="form-control form-control-lg" name="title" placeholder="Name"
                  required />
